...
hi FoldColumn     ctermbg=0           guifg=#000000 guibg=#ffffff   gui=NONE
...
hi Special        ctermfg=2           guifg=#A31515                 gui=NONE
hi SpecialChar    ctermfg=2           guifg=#A31515                 gui=NONE
...
hi javaScriptBraces										guifg=#000000									gui=NONE

"hi VertSplit                                                        gui=NONE  cterm=NONE term=NONE 
hi VertSplit guifg=#555555 guibg=SkyBlue ctermfg=blue  ctermbg=black 

hi MatchParen     ctermfg=0 ctermbg=3 guibg=#335EA8

hi User1 guifg=orangered   guibg=grey20 ctermfg=red   ctermbg=black 
hi User2 guifg=SkyBlue     guibg=grey20 ctermfg=blue  ctermbg=black 
hi User3 guifg=springgreen guibg=grey20 ctermfg=green ctermbg=black  
hi User4 guifg=magenta     guibg=grey20 ctermfg=blue  ctermbg=black 
